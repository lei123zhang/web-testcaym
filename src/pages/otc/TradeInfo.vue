                            ...
                            <div class="trade-operation">
                                <div class="trade-price-input">
                                    <p class="price-input-list">
                                        <Poptip trigger="focus" :content="text1" style="width: 100%;" class="posir">
                                            ...
                                            <p v-show="transform1Tip" class="posia">{{this.$t("otc.tradeinfo.warning2") +this.user.minLimit +"~" +this.user.maxLimit}}</p>
                                        </Poptip>
                                    </p>
                                    ...
                                    <p class="price-input-list">
                                        <Poptip trigger="focus" :content="text2" style="width: 100%;" class="posir">
                                            ...
                                            <p v-show="transform2Tip" class="posia">{{this.$t("otc.tradeinfo.warning4") +this.minNum/10 +"~"+this.user.maxTradableAmount}}</p>
                                        </Poptip>
                                    </p>
                                </div>
...
export default {
  ...
  methods: {
    ...
    transform1() {
      this.mode= 0;
     if(Number(this.buyPrice)<this.user.minLimit||Number(this.buyPrice)>this.user.maxLimit){
        this.transform1Tip = true
      }else{
        this.transform1Tip = false
      }
    ...
    transform2() {
      this.mode = 1;
      if(Number(this.nuyNum)<this.minNum||Number(this.nuyNum)>this.user.maxTradableAmount){
        this.transform2Tip = true
      }else{
        this.transform2Tip = false
      }
    ...
    //   } else {
    //     this.$Message.error(
    //       this.$t("otc.tradeinfo.warning5") +
    //         "或" +
    //         this.$t("otc.tradeinfo.warning6")
    //     );
    //   }
    // },
    sendMsg() {

                            ...
                            <div class="formbox send-form">
                                <Form ref="form" :model="form" :rules="ruleValidate" :label-width="90">
                                    ...
                                    <FormItem :label="$t('otc.publishad.exchangecoin')" prop="coin">
                                        <Select v-model="form.coin" :disabled='isId' @on-change="changeCoin" :placeholder="$t('uc.finance.withdraw.symboltip')">
                                            <Option v-for="item in coinList" :value="item.id">{{item.unit}}</Option>
                                        </Select>
                                    </FormItem>
                                    <FormItem :label="$t('otc.publishad.country')" prop="country">
                                        <Select v-model="form.country" @on-change="onAreaChange" :placeholder="$t('uc.finance.regist.countrytip')">
                                    ...
                                    <FormItem :label="$t('otc.publishad.openfixedprice')">
                                        <i-switch v-model="form.fixed" @on-change="changeCoin" size="large">
                                    ...
                                    <FormItem :label="$t('otc.publishad.exchangeperiod')" prop="timeLimit">
                                        ...
                                        <Select v-model="form.timeLimit" :placeholder="$t('uc.finance.withdraw.select')">
                                              <Option v-for="item in tiemList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                                        </Select>
                                    </FormItem>
                                    ...
                                    <FormItem :label="$t('otc.publishad.paymode')" prop="payMode">
                                        <Select v-model="form.payMode" multiple :placeholder="$t('uc.finance.withdraw.select')">
      ...
      this.$http
        ...
        .then(response => {
          ...
          if (resp.code == 0) {
            ...
            this.tempPrice = resp.data.price;

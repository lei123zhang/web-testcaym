module.exports = {
    ...
    indexMes:{
      index1:{
        title:'ATC FEATURES',
        ms1:'Customized wallet',
        ms2:'Sweep the code to pay',
        ms3:'Three mainstream currencies'
      },
      index2:{
        title:'Multiple benefits',
        ms1:'Initial transaction fee is free of charge',
        ms2:'Time - limited coin - breaking activities',
        ms3:'Invite friends to send nt dollars'
      }
      ,
      index3:{
        ...
        ms1:'Safe and quick',
        ms2:'Quick fix',
        ms3:'Leading technology'
      }
    },
    earth:{
      marketValue:'ATC market value',
      trading:'Transactions',
      TradingVolume:'The total volume',
      registered:'Total registered user',
      certification:'General certifier',
      runtime:'Trading hours'
    },
    sectionPage: {
  ...
  service: {
    ...
    uc:{
      ...
      regist:{
        ...
        countryTip:'The country can not be changed after registration, please select after confirmation',
        emailTip:'Verification mail can sometimes be mistaken for spam, please note that check'
      },
      safe:{
        ...
        hybrid:'Please enter 8-20 digit Numbers and letters mixed',
      ...
      merchCerti:{
        apply:{
          ms1:'To apply for business',
          ms2:'Become an ATC certified merchant with more trading privileges',
          ms3:'Your merchant certification audit has been submitted',
          ms4:'congratulations! Your merchant certification has passed',
          ms5:'sorry! Your merchant"s certification has not passed',
          ms6:'Your business cancellation application has been submitted',
          ms7:'Your business cancellation application has not been approved',
          ms8:'Your business cancellation application has been approved',
          ms9:'You have the following permissions',
          ms10:'Merchants enjoy exclusive advertising booths to increase the transaction success rate',
          ms11:'We will provide one-to-one exclusive services to merchants',
          ms12:'Enjoy lower transaction fees',
          ms13:'I have read and agreed',
          ms14:'Apply immediately'
        },
        title:{
          title1:'To prepare data',
          title2:'Submit audit',
          title3:'Wait for the result',
          title4:'certified',
          title5:'Audit failure',
          title6:'Merchants logout',
          title7:'Submit an application',
          title8:'approved',
        },
        button:{
          button1:'review',
          button2:'why',
          button3:'To apply for',
          button4:'advertising',
          button5:'Apply for loan',
        }
      },
      otcorder:{
        unpaid:'Unpaid',
    ...
    cms:{
      ...
      viewAnnoun:'Click to view the latest announcement and get the latest news as soon as possible',
      qrcode:'Click download to get the qr code, and download the palm app',

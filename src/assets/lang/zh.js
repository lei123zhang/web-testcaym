module.exports = {
    ...
    exchange:{
        ...
        buyamounttipwarningNum:'不允许输入其他符号',
        success: '提交成功',
        pricetip: '请输入交易额',
    ...
    otc:{
        ...
        chat:{
          ...
          finishpayment:'付款完成',
          operatetip_1_1:'转账时请在留言中备注好付款订单号',
    ...
    uc:{
      ...
      regist:{
        ...
        pwdtip:'请输入登录密码',
        pwdmsg:'密码长度不能少于6位',
        hybrid:'请输入8至20位数字及字母混合',
        telno:'手机号',
        email:'邮箱',
        agreementtip:'请点击同意',
        modaltitle:'请校验',
        countryTip:'国家注册后不可更改，请确认后选择',
        emailTip:'验证邮件有时会误判为垃圾邮件，请注意查收'
      },
      safe:{
      ...
      merchCerti:{
        apply:{
          ...
          ms8:'您的商家注销申请已通过',
          ms9:'您获得以下权限',
          ms10:'商家享有专属广告展位，增加交易成功率',
          ms11:'我们将向商家提供一对一专属服务',
          ms12:'享受更低交易手续费',
          ms13:'我已阅读并同意',
          ms14:'立即申请'
        },
      ...
      extension:{
          ...
          title2:'推广好友',
          title3:'我的佣金',
          linkdesc:'以下链接是您对外界推广的地址，所有通过该地址访问过来的用户，注册后您都可以获得一定的佣金奖励！',
          linktitle:'您的推广链接',
          copy:'复制',
          copy_msg1:'复制成功！',
    ...
    cms:{
      noticecenter:'公告中心',
      viewAnnoun:'点击查看最新公告，第一时间获取最新消息',
      newshelp:'新手帮助',
      appdownload:'APP下载',
      qrcode:'点击下载获取二维码，下载掌上app',
      onlineservice:'在线客服',
      faq:'常见问题',
      notice:'公告',
      servicecenter:'客服中心',
    ...
    description: {
        ...
        message3: 'ATC数字资产交易平台支持每秒10000笔交易，给用户带来酣畅淋漓\n的交易体验',
        message4: '从指尖出发，方寸间，纵轻松交易',
        message5: '欢迎使用数交所 ATC 手机客户端APP',
        message6: 'ATC平台特色',
        message7: '定制化钱包',
        message8: '扫码支付',
        message9: '三种主流数组货币',

...
export default {
  ...
  data() {
    ...
    return {
      ...
      aliimg: require("../../assets/img/alipays.png"),
      aliPreview: "",
      weimg: require("../../assets/img/wechats.png"),
      wePreview: "",
      isNoName: true,
      msg: "",
      choseItem: 0,
        ...
        .then(response => {
          ...
          if (resp.code == 0) {
            ...
            this.aliimg = this.aliPreview =
              this.user.alipay == null
                ? this.aliimg
                : this.user.alipay.qrCodeUrl;
...
.accountContent .account-in .account-item .account-detail:before{
    position: absolute;

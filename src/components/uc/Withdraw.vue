                    ...
                    <div class="table-inner action-box">
                            ...
                            <div class="inner-box">
                                <div class="form-group form-address">
                                    ...
                                    <div class="control-input-group">
                                        <Select v-model="withdrawAdress" :placeholder="$t('uc.finance.withdraw.select')">
                        ...
                        <div class="form-group-container">
                            <div class="form-group form-amount">
                                ...
                                <div class="input-group">
                                    <Poptip trigger="focus" :content="$t('uc.finance.withdraw.tip1')+currentCoin.minAmount+' ,'+$t('uc.finance.withdraw.tip2')+currentCoin.maxAmount" style="width: 100%;">
                                        <InputNumber @on-change="computerAmount" v-model="withdrawAmount" :placeholder="$t('uc.finance.withdraw.numtip1')" size="large" style="width: 900px;"></InputNumber>
                        ...
                        <div class="form-group-container form-group-container2">
                            <div class="form-group form-fee">
                                ...
                                <div class="input-group">
                                    ...
                                    <Poptip v-else trigger="focus" :content="$t('uc.finance.withdraw.tip1')+currentCoin.minTxFee+$t('uc.finance.withdraw.tip1')+currentCoin.maxTxFee" style="width: 100%;">
                                        <InputNumber readonly disabled v-model="withdrawFee" :min="currentCoin.minTxFee" :max="currentCoin.maxTxFee" size="large" style="width: 440px;"></InputNumber>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <InputNumber disabled v-model="withdrawOutAmount" :placeholder="$t('uc.finance.withdraw.arriamount')" readonly size="large" style="width: 100%;"></InputNumber>
  ...
  methods: {
    ...
    valid() {
      if (this.coinType == "") {
        ...
        this.$Message.error(
          this.$t("uc.finance.withdraw.numtip2") + this.minAmount
        );
        return false;
